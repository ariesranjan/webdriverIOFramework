exports.config = {
    ...
    // 'cucumber-json' reporter is used to generate the json report in cucumber format so that it could be convereted in Html format using 'multiple-cucumber-html-reporter' module
    // 'spec' reporter is used to print the steps on console while running the scripts, it uses 'wdio-spec-reporter'
